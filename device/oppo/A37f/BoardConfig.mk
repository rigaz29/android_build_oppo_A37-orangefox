...
# OrangeFox MEWAJIBKAN TW_MAX_BRIGHTNESS (orangefox.mk:708 -> $(error)), tidak
# seperti TWRP yang membolehkannya kosong. Nilai 255 dipakai karena itu PERSIS
# yang dihasilkan jalur deteksi otomatis: data.cpp:1378-1391 membaca
# /sys/class/leds/lcd-backlight/max_brightness, dan perangkat melaporkan 255
# (dibaca langsung lewat adb). Jadi ini bukan mengembalikan bug lama -- bug itu
# datang dari nilai 100 warisan device tree TWRP 9.0, bukan dari flag-nya.
...
# OrangeFox mewajibkan pasangan ini (orangefox.mk:646). Nilainya harus sama
# dengan keymaster_ver=4.1 di omni_A37f.mk:20 -- bedanya, TWRP menyetelnya
# sebagai properti produk sedangkan OrangeFox menyetelnya saat jalan lewat
# twrp.cpp:478 android::base::SetProperty("keymaster_ver", ...).
